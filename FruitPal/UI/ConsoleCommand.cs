...
namespace FruitPal
{
    public class ConsoleCommand
    {
        ...
        internal object ParseArgument(Type type, object requiredType, string v, object inputValue)
        {
            throw new NotImplementedException();
        }

        internal object ParseArgument()
        {
            throw new NotImplementedException();
        }

        internal object Validate(string v, object name)
        {
            throw new NotImplementedException();
        }
